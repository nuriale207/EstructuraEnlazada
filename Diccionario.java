...
public class Diccionario {
	private UnorderedCircularLinkedList<String> diccionario;
	private static Diccionario miDiccionario= new Diccionario();
	private Diccionario () {
		this.diccionario= new UnorderedCircularLinkedList<String>();
	}
	...
	public void cargarDiccionario(String nomF) {
		...
		try {
			...
			while(entrada.hasNext()) {
				this.diccionario.addToRear(entrada.next());
			}
			entrada.close();
	...
	public void anadirPalabra(String pPalabra) {
		...
		this.diccionario.addToRear(pPalabra);
	...
	private  void mergeSort(UnorderedCircularLinkedList<String> lista,int inicio, int fin) {
		//Pre:el diccionario contiene al menos un elemento
...
private void diccionarioOrdenado(UnorderedCircularLinkedList<String> lista, int inicio, int centro,int fin){
	//Pre:el diccionario contiene al menos un elemento
